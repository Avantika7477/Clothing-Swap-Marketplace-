const SwapValueCard = ({ listing }) => {
  ...
  return (
    <div className="rounded-2xl border border-moss-800/15 bg-moss-50 p-6">
      <h2 className="font-display text-2xl font-medium text-moss-800">Swap value</h2>

      <div className="mt-6">
        <p className="text-ink/55">Estimated points</p>
        <h3 className="mt-2 font-display text-5xl font-medium text-moss-800">{value}</h3>
      </div>
